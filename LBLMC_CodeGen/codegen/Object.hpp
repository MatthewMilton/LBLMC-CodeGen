...
/**
	...
	Each instance of the codegen::Object class describes a single C++ object that can exist in
	generated C++ code. The qualifiers, type, label, and default/literal value of the object is
	described.  From the description, codegen::Object can generate appropriate C++ declarations,
	...
	are valid C++ code so codegen::Object can generate valid C++ code.
...
public:
	...
	**/
	Object(std::string type, std::string label, std::string value) :
		...
		value(value)
	{
		if(type.empty()) throw std::invalid_argument("codegen::Object constructor(): type cannot be empty or null");
		if(label.empty()) throw std::invalid_argument("codegen::Object constructor(): label cannot be empty or null");
	}
	...
	**/
	...
	{
		if(this->type.empty()) throw std::invalid_argument("codegen::Object::setType(): type cannot be empty or null");
	...
	**/
	...
	{
		if(this->label.empty()) throw std::invalid_argument("codegen::Object::setLabel(): label cannot be empty or null");
	...
	**/
	...
	{
		if(type.empty()) throw std::runtime_error("codegen::Object::generateDeclaration(): type cannot be empty or null");
		if(label.empty()) throw std::runtime_error("codegen::Object::generateDeclaration(): label cannot be empty or null");
	...
	**/
	...
	{
		if(type.empty()) throw std::runtime_error("codegen::Object::generateDefinition(): type cannot be empty or null");
		if(label.empty()) throw std::runtime_error("codegen::Object::generateDefinition(): label cannot be empty or null");
	...
	**/
	...
	{
		if(label.empty()) throw std::runtime_error("codegen::Object::generateAssignment(): label cannot be empty or null");
		if(value.empty()) throw std::runtime_error("codegen::Object::generateAssignment(): value cannot be empty or null");
	...
	**/
	...
	{
		if(label.empty()) throw std::runtime_error("codegen::Object::generateAssignment(): label cannot be empty or null");
		if(v.empty()) throw std::invalid_argument("codegen::Object::generateAssignment(): argument v cannot be empty or null");
	...
	**/
	...
	{
		if(type.empty()) throw std::runtime_error("codegen::Object::generateArgument(): type cannot be empty or null");
		if(label.empty()) throw std::runtime_error("codegen::Object::generateArgument(): label cannot be empty or null");
