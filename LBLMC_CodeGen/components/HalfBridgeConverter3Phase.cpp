...
#include "HalfBridgeConverter3Phase.hpp"
...
HalfBridgeConverter3Phase::HalfBridgeConverter3Phase(std::string comp_name) :
	Component(comp_name),
	...
	source_id_A(0), source_id_B(0), source_id_C(0)
{
	if(comp_name.empty())
	{
		throw std::invalid_argument("HalfBridgeConverter3Phase::constructor(): comp_name must be a valid, non-empty C++ label");
	}
}

HalfBridgeConverter3Phase::HalfBridgeConverter3Phase
(
	...
	source_id_A(0), source_id_B(0), source_id_C(0)
{
	...
	{
		throw std::invalid_argument("HalfBridgeConverter3Phase::constructor(): parameters dt, cap, and ind must be positive nonzero values");
	}
}

HalfBridgeConverter3Phase::HalfBridgeConverter3Phase(const HalfBridgeConverter3Phase& base) :
	Component(comp_name),
...
void HalfBridgeConverter3Phase::getSourceIds(std::vector<unsigned int>& ids) const
{
	ids.clear();
...
void HalfBridgeConverter3Phase::stampConductance(SystemConductanceGenerator& gen)
{
...
void HalfBridgeConverter3Phase::stampSources(SystemSourceVectorGenerator& gen)
{
...
std::string HalfBridgeConverter3Phase::generateParameters()
{
	const static double HOC = DT/CAP;
	const static double HOL = DT/IND;
...
std::string HalfBridgeConverter3Phase::generateFields()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateInputs()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateOutputs(std::string output)
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateOutputsUpdateBody(std::string output)
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateUpdateBody()
{
...
std::string HalfBridgeConverter3Phase::generateCPVoltageOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateCNVoltageOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateLACurrentOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateLBCurrentOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase::generateLCCurrentOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
