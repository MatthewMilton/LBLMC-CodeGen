...
#include "HalfBridgeConverter3Phase2.hpp"
...
HalfBridgeConverter3Phase2::HalfBridgeConverter3Phase2(std::string comp_name) :
	Component(comp_name),
	...
	source_id_A(0), source_id_B(0), source_id_C(0)
{
	if(comp_name.empty())
	{
		throw std::invalid_argument("HalfBridgeConverter3Phase2::constructor(): comp_name must be a valid, non-empty C++ label");
	}
}

HalfBridgeConverter3Phase2::HalfBridgeConverter3Phase2
(
	...
	source_id_A(0), source_id_B(0), source_id_C(0)
{
	...
	{
		throw std::invalid_argument("HalfBridgeConverter3Phase2::constructor(): parameters dt, cap, and ind must be positive nonzero values");
	}
}

HalfBridgeConverter3Phase2::HalfBridgeConverter3Phase2(const HalfBridgeConverter3Phase2& base) :
	Component(comp_name),
...
void HalfBridgeConverter3Phase2::getSourceIds(std::vector<unsigned int>& ids) const
{
	ids.clear();
...
void HalfBridgeConverter3Phase2::stampConductance(SystemConductanceGenerator& gen)
{
...
void HalfBridgeConverter3Phase2::stampSources(SystemSourceVectorGenerator& gen)
{
...
std::string HalfBridgeConverter3Phase2::generateParameters()
{
	const static double HOC = DT/CAP;
	const static double HOL = DT/IND;
...
std::string HalfBridgeConverter3Phase2::generateFields()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateInputs()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateOutputs(std::string output)
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateOutputsUpdateBody(std::string output)
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateUpdateBody()
{
...
std::string HalfBridgeConverter3Phase2::generateCPVoltageOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateCNVoltageOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateLACurrentOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateLBCurrentOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
...
std::string HalfBridgeConverter3Phase2::generateLCCurrentOutputUpdateBody()
{
	std::stringstream sstrm;
	sstrm <<
	std::setprecision(16) <<
